...
from ilqr.cost import PathQRCost, AutoDiffCost, FiniteDiffCost, BatchAutoDiffCost
...
class LegiblePathCost(BatchAutoDiffCost):
    ...
    def __init__(self, exp, x_path, u_path, **kwargs):
    ...
    def legib_path_cost_make_self(self, exp, Q, R, Qf, x_path, u_path, start, target_goal, goals, N, dt, restaurant=None, file_id=None, Q_terminal=None, **kwargs):
        """Constructs a QRCost.
        Args:
